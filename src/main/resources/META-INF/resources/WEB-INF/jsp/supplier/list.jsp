                        ...
                        <div class="col-md-12">
                            <div class="portlet light">
                                <div class="portlet-title">
                                    <div class="caption"><i class="fa "></i>供货信息列表 </div>
                                    <div class="actions">
                                        <a href="javascript:;" class="btn btn-circle btn-info add-btn">
                                            <i class="fa fa-plus"></i>
                                            <span class="hidden-xs add-code" onclick="location.href='${ctx}/supplier/item/publish'"> 添加 </span>
                                        </a>
                                    </div>
                                </div>
                                            ...
                                            <tbody> 
                                            	...
                                            	<tr role="row" class="filter">
                                                    ...
                                                    <td>
                                                    	...
                                                    	<c:if test="${data.state==1}">出售中</c:if>
                                                    	<c:if test="${data.state==2}">已停止</c:if>
                                                    </td>
                                                    <td>
                                                        <div class="margin-bottom-5">
                                                            <button class="btn btn-sm btn-success filter-submit margin-bottom" 
                                                            onclick="window.location.href='${ctx}/supplier/item/edit/${data.id }'" >
                                                                <i class="fa "></i> 编辑
                                                            </button>
                                                        </div>
                                                        <div class="margin-bottom-5">
