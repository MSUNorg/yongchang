                        ...
                        <div class="col-md-12">
                            <div class="portlet light">
                                <div class="portlet-title">
                                    <div class="caption"><i class="fa "></i>角色列表 </div>
                                    <div class="actions">
                                        <a href="javascript:;" class="btn btn-circle btn-info"
                                        onclick="location.href='${ctx}/admin/role/0'">
                                        ...
                                        <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_products">
                                            ...
                                            <tbody> 
                                            	...
                                            	<tr role="row" class="filter">
                                                    ...
                                                    <td>${data.name}</td>
                                                    <td>
                                                    	<c:forEach  items="${data.getResourceList()}" var="item">
                                                    	${map.get(item)},
                                                    	</c:forEach>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div class="margin-bottom-5">
                                                            ...
                                                            onclick="location.href='${ctx}/admin/role/${data.id}'">
                                                                <i class="fa "></i> 编辑
                                                            </button>
                                                        </div>
                                                        <div class="margin-bottom-5">
