...
<rapid:override name="head">  
    ...
    function modify(id,state) {
		if(!id) return;
		$.ajax({
   			url: "/admin/require/modify",
   			type: "POST",
   			cache: false,
   			dataType: "json",
   			data: {"requireId":id,"state":state},
    ...
    function del(id) {
		...
		$.ajax({
   			...
   			success: function(data) {
   				...
   				if(data.status){
   					window.location.href = "${ctx}/supplier/require";
   				}
   			},
   			error: function(XMLHttpRequest, textStatus, errorThrown) {
                alert("服务器错误码:"+XMLHttpRequest.status);
                            ...
                            <div class="portlet light">
                                <div class="portlet-title">
                                    ...
                                    <div class="actions">
                                        ...
                                        onclick="location.href='${ctx}/admin/require/0'">
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="margin-bottom-5">
                                                        	<button class="btn btn-sm btn-default filter-cancel margin-bottom"
                                                        		onclick="location.href='${ctx}/admin/require/${data.id}'">
	                                                            <i class="fa "></i> 修改
	                                                        </button>
                                                        </div>
                                                        <c:if test="${data.finishCount > 0}">
                                                        <div class="margin-bottom-5">
	                                                        <button class="btn btn-sm btn-default filter-cancel margin-bottom"
		                                                        onclick="del(${data.id})">
		                                                            <i class="fa "></i> 删除
                                                        ...
                                                        <div class="margin-bottom-5">
	                                                        <button class="btn btn-sm btn-default filter-cancel margin-bottom"
	                                                        onclick="location.href='${ctx}/admin/bid/${data.id}'">
	                                                            <i class="fa "></i> 查看竞标
	                                                        </button>
                                                        </div>
                                                    </td>
