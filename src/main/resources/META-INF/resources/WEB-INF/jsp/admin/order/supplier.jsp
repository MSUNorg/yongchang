    ...
    $(function () {
		...
		$(".btn-search").click(function() {
    		...
    		var end=$('#date-end').val();
   			window.location.href = "${ctx}/admin/order/supplier?start="+start+"&end="+end;
   		});
    })
    function cancel(id) {
		if(!id) return;
		$.ajax({
   			url: "/admin/order/supplier/cancel/"+id,
   			type: "POST",
   			cache: false,
   			dataType: "json",
   			success: function(data) {
   				...
   				if(data.status){
   					window.location.href = "${ctx}/admin/order/supplier";
   				}
   			},
