                        ...
                        <div class="col-md-12">
                            <div class="portlet light">
                                <div class="portlet-title">
                                    <div class="caption"><i class="fa "></i>首页轮播图列表 </div>
                                    <div class="actions">
                                        <a href="javascript:;" class="btn btn-circle btn-info add-btn" 
                                        onclick="location.href='${ctx}/admin/cms/slideshow/0'">
                                ...
                                <div class="portlet-body">
                                    <div class="table-container">
                                        <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_products">
                                            ...
                                            <tbody> 
                                            	<c:forEach items="${list}" var="data" varStatus="loopCounter">
                                            	<tr role="row" class="filter">
                                                    ...
                                                    <td>
                                    					...
                                    					<img src="${ctx}/img?img=${data.pic}" alt="" width="200" height="150" /> 
                                    					</c:if>
                                                    </td>
                                                    <td>${data.link}</td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div class="margin-bottom-5">
                                                            ...
                                                            onclick="location.href='${ctx}/admin/cms/slideshow/${data.id}'">
                                                                <i class="fa "></i> 编辑
                                                            </button>
                                                        </div>
                                                        <div class="margin-bottom-5">
